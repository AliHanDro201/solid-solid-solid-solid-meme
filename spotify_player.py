...
class Spotify_Player:
    ...
    def __init__(self):
        ...
        self.spotifyObject = spotipy.Spotify(
            ...
            auth_manager=SpotifyOAuth(
                client_id=os.getenv('4536cf19573f4fc993255d239d5bfb14'),
                client_secret=os.getenv("16fee089bcda46639e13069e5fa40acf"),
                redirect_uri=os.getenv("http://localhost:5000"),
                scope=[
                    "streaming", 
    ...
    def check_for_client_id(self) -> bool:
        ...
        """
        if os.getenv("4536cf19573f4fc993255d239d5bfb14") != None:
            return True
        else:
            return False
